...
export const VALUE_DEFINITIONS: ValueProps[] = [
  ...
  {
    label: "Respeito",
    icon: ValueEnum.RESPECT
  },
  {
    label: "Transparencia",
    icon: ValueEnum.TRANSPARENCY
  },
  {
    label: "Qualidade",
    icon: ValueEnum.QUALITY
  },
  {
    label: "Ética",
    icon: ValueEnum.ETHICS
  },
  {
    label: "Colaboração",
    icon: ValueEnum.COLABORATION
  },
  {
    label: "Responsabilidade",
    icon: ValueEnum.RESPONSABILITY
  },
  {
    label: "Inovação",
...
export const ROOFTOP_RESIDENCE_DEFINITIONS: ValueProps[] = [
  {
    label: "113 M2 - 136 M2",
    icon: ValueEnum.METRICS
  },
  {
    label: "2 QUARTOS (1 OU 2 SUÍTES)",
    icon: ValueEnum.SUITES
  },
  {
